...
class Config:
    ...
    DB_USER = os.getenv("DB_USER", "vardan")
    DB_PASSWORD = os.getenv("DB_PASSWORD", "varev05")
...
class TestingConfig(Config):
    ...
    DB_NAME = "ml_api_test"
    SQLALCHEMY_DATABASE_URI = f"postgresql+psycopg2://{DB_USER}:" f"{DB_PASSWORD}@{DB_HOST}:{DB_PORT}/{DB_NAME}"
